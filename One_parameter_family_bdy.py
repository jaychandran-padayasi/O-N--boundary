...
Bulk_Operators = [1.5113601, 3.78901, 6.99789631, 'Delta_e1']
Bdy_Operators = [2.0, 3.0, 5, 7]
...
print('Boundary Operators: ', Bdy_Operators)
...
res = minimize(evaluate, np.array([12]), args=(derMatrix_expr), method='Nelder-Mead', options={'disp':True})
print(res)
[delta_e1_min] = res.x
print('delta_e1_min = ', delta_e1_min)
...
print("mu_(sO)^2 = ", params[6])
print("mu_(phiO)^2 = ", params[7])
print("a_s^2 = ", params[8])
